...
<head>
    <meta charset="UTF-8">
    <title>Panel entrenador - Fit360</title>
...
<div id="loading-screen">
    <div class="loading-content">
        ...
        <p class="loading-text">Cargando tu panel de entrenador...</p>
    ...
    <main class="main-content">
        ...
        <section class="dashboard-banner">
            <div class="banner-text">
                ...
                <p class="subtitle">Tu panel como entrenador</p>
                <span class="description">Gestiona rutinas, clases y el seguimiento de tus alumnos.</span>
            </div>
        </section>
        ...
        <section class="dashboard-grid">
            ...
            <div class="card">
                ...
                <div class="title">12 rutinas asignadas</div>
                <span>Revisa y ajusta los planes de entrenamiento.</span>
            </div>

            <div class="card">
                <img src="../../assets/img/dashboard/icon-classes.png" class="card-icon" alt="">
                <h3>Clases de hoy</h3>
                <p class="title">3 clases programadas</p>
                <span>Consulta horarios y asistentes.</span>
            </div>

            <div class="card">
                <img src="../../assets/img/dashboard/icon-progress.png" class="card-icon" alt="">
                <h3>Progreso alumnos</h3>
                <p class="title">Seguimiento activo</p>
                <span>Detecta quién necesita más apoyo.</span>
            </div>

            <div class="card">
                <img src="../../assets/img/dashboard/icon-stats.png" class="card-icon" alt="">
                <h3>Actividad semanal</h3>
                <p class="title">8 sesiones impartidas</p>
                <span>Rendimiento de la semana actual.</span>
            </div>

            <div class="card">
                <img src="../../assets/img/dashboard/icon-time.png" class="card-icon" alt="">
                <h3>Próxima sesión</h3>
                <p class="title">Funcional con pesas</p>
                <span>Hoy - 19:00 h</span>
            </div>

            <div class="card">
                <img src="../../assets/img/dashboard/icon-calendar.png" class="card-icon" alt="">
                <h3>Agenda</h3>
                <p class="title">Planificación semanal</p>
                <span>Organiza tus clases y rutinas.</span>
            </div>
